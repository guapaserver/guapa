...
class Configuracao
{
	...
	public function url_fisico()
	{
		...
		$configuracao["url_fisico"] = $_SERVER['DOCUMENT_ROOT']."/guapa/";
	...
	{
		$configuracao["url_virtual"] = "http://".$_SERVER['HTTP_HOST']."/guapa/";
	...
	{
		$configuracao["backup_path"] = $_SERVER['DOCUMENT_ROOT']."/guapa/imagens/backup/";
	...
	public function banco_dados()
	{
		...
		$configuracao["banco_dados"] = "guapa";
	...
	{
		$configuracao["site_nome"] = "AGENCIA GUAPA";
	...
	{
		$configuracao["site_titulo"] = "AGENCIA GUAPA";
